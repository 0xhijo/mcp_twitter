...
import { createAndPostTwitterThread, createTwitterpost, FollowXUserFromUsername, getLastTweetsAndRepliesFromUser, getLastTweetsFromUser, getLastTweetsOptions, getLastUserTweet, getOwnTwitterAccountInfo, getTwitterProfileFromUsername, getTwitterUserIdFromUsername, ReplyTweet } from "./tools/twitter.js";
import { createAndPostTwitterThreadSchema, createTwitterpostSchema, FollowXUserFromUsernameSchema, getLastTweetsAndRepliesFromUserSchema, getLastTweetsFromUserSchema, getLastTweetsOptionsSchema, getLastUserXTweetSchema, getTwitterProfileFromUsernameSchema, getTwitterUserIdFromUsernameSchema, ReplyTweetSchema } from "./schema/index.js";
dotenv.config();
...
export const registerTools = (TwitterToolRegistry) => {
...
export const RegisterToolInServer = async (twitter) => {
    const tools = [];
...
async function main() {
    ...
    if (!checkEnv(process.env.TWITTER_AUTH_MODE)) {
